        ...
        <div className="container">
            ...
            <div className="col-md-6 ov-h">
                ...
                <div className="col-sm-4">
                    ...
                    </p><a href="https://" className="btn btn-color-out btn-sm">Hire Us!</a>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="widget">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li>
                        <a href="https://">Process</a>
                        </li>
                        <li>
                        <a href="https://">Story</a>
                        </li>
                        <li>
        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="footer-social">
                    <ul>
                    <li>
                        <a target="_blank" href="https://" rel="noreferrer"><i className="ti-facebook"></i></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://" rel="noreferrer"><i className="ti-twitter-alt"></i></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://" rel="noreferrer"><i className="ti-linkedin"></i></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://" rel="noreferrer"><i className="ti-instagram"></i></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://" rel="noreferrer"><i className="ti-dribbble"></i></a>
                    </li>
                    </ul>
                </div>
                </div>
