...
const ProductSingle = () => {
  ...
  useEffect(() => {
    ...
    axios.get(` http://localhost:5050/catagory/${product.catagoryId}/products`).then(res => {
              ...
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    {
                      product.sale_price ?
                      <h3 style={{width:'500px',display:'inline-block'}}><del>{product.regular_price } Tk</del> <span>{ product.sale_price }BDT</span></h3>:<h3><span>{ product.regular_price }BDT</span></h3>
                    }
                  </div>
              ...
              related.map(data =>
                ...
                <div class="shop-product">
                  ...
                  <div class="product-info">
                    <h4 class="upper"><a href="https://">{data.name}</a></h4><span> BDT</span>
